(() => {
  ...
  function pauseActivity() { window.Basahin?.cancelAll();
  ...
  function render(message = '', messageType = '') {
    ...
    window.Basahin.bindActivity(app.querySelector('#read'), readWord);
  ...
  function stopStream() { window.Basahin?.cancelAll();
