(function () {
    const words = [
        ...
        "Si Carlo ay pumunta sa paaralan nang maaga.",
        "Ang guro ay nagturo ng bagong salita.",
        "Masaya kaming nagbasa sa silid-aralan.",
        "Ang bata ay tumingin sa makulay na ulap.",
        "Si Lito ay nagsulat ng maikling pangungusap.",
        "Nagpraktis kami ng pagbasa araw-araw.",
        "Ang kaibigan ko ay mabilis magbasa.",
        "Si Maya ay maingat na bumigkas ng mga salita.",
        "Tuwang-tuwa ang klase sa reading activity."
    ];
    let currentIndex = 0;
