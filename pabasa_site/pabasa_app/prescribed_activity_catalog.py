...
PRESCRIBED_ACTIVITIES = {
    ...
    'lesson-16-gawain-1': {
        ...
        'lesson_number': 16,
        'gawain_number': 1,
        'display_title': 'Lesson 16: Gawain 1',
        'title': 'Nawawalang Pantig',
        'description': 'Bilugan ang nawawalang pantig para sa bawat larawan.',
        'instruction': 'Bilugan ang nawawalang pantig para sa larawan.',
        'interaction': 'choice',
        'total_items': 5,
        'thumbnail': 'pabasa_app/images/lesson_16/gumamela.png',
        'items': [
            {'word': 'gumamela', 'stem': 'mamela', 'choices': ['ga', 'nga', 'gu'], 'answer': 'gu', 'image_path': 'pabasa_app/images/lesson_16/gumamela.png', 'alt_text': 'Larawan ng gumamela'},
            {'word': 'banga', 'stem': 'nga', 'choices': ['da', 'ba', 'bu'], 'answer': 'ba', 'image_path': 'pabasa_app/images/lesson_16/banga.png', 'alt_text': 'Larawan ng banga'},
            {'word': 'gusali', 'stem': 'sali', 'choices': ['gu', 'ngu', 'gi'], 'answer': 'gu', 'image_path': 'pabasa_app/images/lesson_16/gusali.png', 'alt_text': 'Larawan ng gusali'},
            {'word': 'ngiti', 'stem': 'ti', 'choices': ['ngu', 'nge', 'ngi'], 'answer': 'ngi', 'image_path': 'pabasa_app/images/lesson_16/ngiti.png', 'alt_text': 'Larawan ng ngiti'},
            {'word': 'gata', 'stem': 'ta', 'choices': ['ga', 'gi', 'ngo'], 'answer': 'ga', 'image_path': 'pabasa_app/images/lesson_16/gata.png', 'alt_text': 'Larawan ng gata'},
        ],
    },
    'lesson-16-gawain-2': {
        'activity_key': 'lesson-16-gawain-2', 'session_key': 'session-6',
        'session_number': 6,
        'lesson_number': 16,
        'gawain_number': 2,
        'display_title': 'Lesson 16: Gawain 2',
        'title': 'Punan ang Pantig',
        'description': 'Punan ang nawawalang pantig para mabuo ang ngalan ng larawan.',
        'instruction': 'Punan ang pantig para mabuo ang ngalan ng mga larawan.',
        'interaction': 'written',
        'total_items': 5,
        'thumbnail': 'pabasa_app/images/lesson_16/gumamela.png',
        'items': [
            {'word': 'gumamela', 'stem': 'mamela', 'answer': 'gu', 'image_path': 'pabasa_app/images/lesson_16/gumamela.png', 'alt_text': 'Larawan ng gumamela'},
            {'word': 'banga', 'stem': 'nga', 'answer': 'ba', 'image_path': 'pabasa_app/images/lesson_16/banga.png', 'alt_text': 'Larawan ng banga'},
            {'word': 'gusali', 'stem': 'sali', 'answer': 'gu', 'image_path': 'pabasa_app/images/lesson_16/gusali.png', 'alt_text': 'Larawan ng gusali'},
            {'word': 'ngiti', 'stem': 'ti', 'answer': 'ngi', 'image_path': 'pabasa_app/images/lesson_16/ngiti.png', 'alt_text': 'Larawan ng ngiti'},
            {'word': 'gata', 'stem': 'ta', 'answer': 'ga', 'image_path': 'pabasa_app/images/lesson_16/gata.png', 'alt_text': 'Larawan ng gata'},
        ],
    },
    'lesson-16-gawain-3': {
...
for _key, _workbook in PRESCRIBED_WORKBOOK_ACTIVITIES.items():
    PRESCRIBED_ACTIVITIES[_key] = {
        ...
        'section_key': _workbook.get('section_key'),
        'section_label': _workbook.get('section_label'),
        'section_order': _workbook.get('section_order'),
        'display_gawain_number': _workbook.get('display_gawain_number', _workbook.get('activity_number')),
        'section_display_label': _workbook.get('section_display_label', _workbook.get('display_label')),
