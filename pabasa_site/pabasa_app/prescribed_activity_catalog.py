...
PRESCRIBED_ACTIVITIES = {
    ...
    'lesson-31-gawain-2': {
        ...
        'instruction': 'Read the choices, drag the correct word to the blank, then read the complete sentence.',
        'interaction': 'oral_drag_sentence', 'total_items': 5,
        'word_choices': ['pet', 'sit', 'sip', 'lit', 'mat'],
        'items': [
            {'id': 'pet', 'before': 'Ben has a ', 'after': '.', 'sentence': 'Ben has a pet.', 'answer': 'pet', 'choices': ['pet', 'pen', 'net']},
            {'id': 'sit', 'before': 'I ', 'after': ' on the mat.', 'sentence': 'I sit on the mat.', 'answer': 'sit', 'choices': ['sit', 'sip', 'lit']},
            {'id': 'sip', 'before': 'I ', 'after': ' from a cup.', 'sentence': 'I sip from a cup.', 'answer': 'sip', 'choices': ['sip', 'sit', 'lip']},
            {'id': 'lit', 'before': 'The lamp is ', 'after': '.', 'sentence': 'The lamp is lit.', 'answer': 'lit', 'choices': ['lit', 'sit', 'lip']},
            {'id': 'mat', 'before': 'The cat is on the ', 'after': '.', 'sentence': 'The cat is on the mat.', 'answer': 'mat', 'choices': ['mat', 'pet', 'pen']},
        ],
    },
    'lesson-31-gawain-3': {
    ...
    'lesson-31-gawain-4': {
        ...
        'instruction': 'Say the name of the picture, then box the correct word.',
        'interaction': 'oral_picture_box', 'total_items': 5,
        'items': [
            {'id': 'bell', 'image_path': 'pabasa_app/images/lesson_31/bell.png', 'word': 'bell', 'choices': ['bell', 'ball'], 'alt_text': 'A bell'},
            {'id': 'orange', 'image_path': 'pabasa_app/images/lesson_31/orange.png', 'word': 'orange', 'choices': ['orange', 'olive'], 'alt_text': 'An orange'},
            {'id': 'bee', 'image_path': 'pabasa_app/images/lesson_31/bee.png', 'word': 'bee', 'choices': ['bee', 'banana'], 'alt_text': 'A bee'},
            {'id': 'olive', 'image_path': 'pabasa_app/images/lesson_31/olive.png', 'word': 'olive', 'choices': ['olive', 'orange'], 'alt_text': 'Olives'},
            {'id': 'banana', 'image_path': 'pabasa_app/images/lesson_31/banana.png', 'word': 'banana', 'choices': ['banana', 'bell'], 'alt_text': 'A banana'},
        ],
    },
    'lesson-13-gawain-1': {
