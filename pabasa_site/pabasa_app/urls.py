...
urlpatterns = [
    ...
    path('learner-experience-rating/', views.learner_experience_rating, name='learner_experience_rating'),
    ...
    path('api/register/check-duplicates/', views.check_signup_duplicates, name='check_signup_duplicates'),
    ...
    path('dashboard/admin/activity-log/', views.admin_activity_log, name='admin_activity_log'),
    ...
    path('dashboard/assessment/activity/word-decoding/', views.word_decoding_page, name='word_decoding_page'),
    ...
    path('dashboard/assessment/activity/prescribed/lesson2-gawain1/', views.salitang_magkatugma_page, name='prescribed_lesson2_gawain1'),
    ...
    path('dashboard/assessment/activity/prescribed/lesson3-gawain1/', views.lesson_3_gawain_1_page, name='prescribed_lesson3_gawain1'),
    ...
    path('api/story-response/submit', views.story_response_submit),
    ...
    path('api/teacher/retell-recordings/', views.teacher_retell_recordings, name='teacher_retell_recordings'),
    path('api/teacher/retell-recording/<int:submission_id>/', views.teacher_retell_recording, name='teacher_retell_recording'),
    ...
    path('dashboard/assessment/lesson-6/gawain-1/', views.lesson_6_gawain_1_page, name='lesson_6_gawain_1_page'),
    path('dashboard/assessment/lesson-7/gawain-1/', views.lesson_7_gawain_1_page, name='lesson_7_gawain_1_page'),
    ...
    path('dashboard/assessment/lesson-6/activity-progress/', views.lesson_3_activity_progress, name='lesson_6_activity_progress'),
    path('dashboard/assessment/lesson-7/activity-progress/', views.lesson_3_activity_progress, name='lesson_7_activity_progress'),
    ...
    path('dashboard/teacher/active-live-assessment/', views.active_live_assessment, name='active_live_assessment'),
    ...
    path('api/live-assessment/session/<str:session_id>/recovery-validation/', views.live_assessment_recovery_validation, name='live_assessment_recovery_validation'),
