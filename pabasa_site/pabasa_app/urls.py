...
urlpatterns = [
    ...
    path('dashboard/assessment/lesson-4/gawain-3/', views.session_4_gawain_3_page, name='session_4_gawain_3_page'),
    path('dashboard/assessment/lesson-4/gawain-4/', views.session_4_gawain_4_page, name='session_4_gawain_4_page'),
