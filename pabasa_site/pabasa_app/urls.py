...
urlpatterns = [
    ...
    path('dashboard/admin/official-reading-assessments/<int:material_id>/override-request/', views.admin_official_reading_override_request, name='admin_official_reading_override_request'),
    path('dashboard/admin/official-reading-assessments/<int:material_id>/override-authorize/', views.admin_official_reading_assessment_override_authorize, name='admin_official_reading_assessment_override_authorize'),
    path('dashboard/admin/official-reading-assessments/<int:material_id>/edit/', views.admin_official_reading_assessment_edit, name='admin_official_reading_assessment_edit'),
